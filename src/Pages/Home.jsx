...
const Home = ({ isDarkMode }) => {
  ...
  const handleRatingClick = (courseId, newRating) => {
      ...
      prevCourses.map(course =>
        course.id === courseId
          ? {
              ...
              totalRating: course.totalRating + newRating,
              rating: (course.totalRating + newRating) / (course.ratingCount + 1),
            }
          : course
      )
    );
                      ...
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <FaStar
                            ...
                            onClick={() => handleRatingClick(course.id, i + 1)}
                          />
                        ))}
                      </div>
